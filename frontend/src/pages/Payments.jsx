    ...
    <div className="space-y-5 animate-fade-in">
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-slate-900/60 dark:bg-slate-950/80 backdrop-blur-sm z-50 flex items-start sm:items-center justify-center p-3 pt-6 pb-6 sm:p-4 touch-none">
          <div
            className="bg-white dark:bg-slate-800 rounded-2xl shadow-elevated dark:shadow-none w-full max-w-md flex flex-col overflow-hidden border border-slate-100 dark:border-slate-700 h-[82vh] max-h-[82dvh] sm:h-auto sm:max-h-[90vh] transition-all transform"
